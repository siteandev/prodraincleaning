...
const HERO_IMAGE_SRC = '/assets/images/local-drain-cleaner-vs-national-chain-two-paths.png';
const HERO_IMAGE_ALT = 'Comparing a local Winnipeg drain cleaning company to a national chain';

const tocItems = [
  { id: 'at-a-glance', label: 'At a Glance' },
  { id: 'why-this-comparison-matters', label: 'Why This Comparison Matters for Drains' },
  { id: 'national-chain-structure', label: 'What a National Chain Structure Actually Means' },
  { id: 'what-local-means', label: 'What "Local" Actually Means Here' },
  { id: 'questions-to-ask', label: 'Questions Worth Asking Whoever You Call' },
  { id: 'areas-we-serve', label: 'Every Area We Serve Directly' },
...
const faqs = [
  {
    q: 'Is a local company always better than a national chain?',
    a: 'Not automatically — but a local company typically means direct dispatch and consistent accountability, which matters most for time-sensitive drain issues.',
  },
  {
    q: 'Do national chains cost more?',
    a: 'Pricing structures vary by company and location — ask directly how pricing is set before assuming either way.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes — calls are answered directly, not routed through a separate national call centre.',
  },
  {
    q: 'Do you serve areas outside Winnipeg proper?',
    a: 'Yes — the full 100km radius, with the same standard everywhere in it.',
  },
];

const comparisonRows = [
  {
    factor: 'Who answers the phone',
    local: 'A person based in your area',
    national: 'Often a national call centre first',
  },
  {
    factor: 'Dispatch',
    local: 'Direct to a nearby technician',
    national: 'Often routed through a booking system before local dispatch',
  },
  {
    factor: 'Pricing structure',
    local: 'Set by the local operator',
    national: 'Often standardized nationally, may not reflect local competition',
  },
  {
    factor: 'Accountability',
    local: 'Same business, same community, every time',
    national: 'Franchise structure can mean different standards at different locations',
  },
  {
    factor: 'Local knowledge',
    local: "Familiar with the area's specific pipe ages, soil, and municipal system",
    national: 'Varies by franchise location and staff turnover',
  },
];
...
const pageSchema = {
  ...
  '@graph': [
    {
      '@type': 'Article',
      headline: 'Local Drain Cleaner vs. a National Chain — What Actually Matters',
      description:
      ...
      image: {
        '@type': 'ImageObject',
        url: 'https://prodraincleaning.ca/assets/images/local-drain-cleaner-vs-national-chain-two-paths.png',
        description: HERO_IMAGE_ALT,
      },
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://prodraincleaning.ca/compare/local-drain-cleaner-vs-national-chain',
      },
    },
    {
      '@type': 'FAQPage',
    ...
    },
    {
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://prodraincleaning.ca' },
        {
          ...
          position: 2,
          name: 'Compare',
          item: 'https://prodraincleaning.ca/compare',
        },
        {
          '@type': 'ListItem',
          position: 3,
          name: 'Local Drain Cleaner vs. a National Chain — What Actually Matters',
          item: 'https://prodraincleaning.ca/compare/local-drain-cleaner-vs-national-chain',
        },
      ],
    },
  ],
...
export default function LocalDrainCleanerVsNationalChainPage() {
      ...
      <main id="main-content">
        ...
        <nav aria-label="Breadcrumb" className="bg-white border-b" style={{ borderColor: 'var(--line)' }}>
          <div className="container-wide py-3">
            <ol className="flex items-center gap-2 text-sm flex-wrap" style={{ color: 'var(--muted)' }}>
              ...
              <li>
                <Link href="/compare" className="hover:underline" style={{ color: 'var(--navy-700)' }}>
                  Compare
                </Link>
              </li>
              <li aria-hidden="true">›</li>
              <li aria-current="page" className="truncate max-w-xs" style={{ color: 'var(--ink)' }}>
                Local Drain Cleaner vs. a National Chain
              </li>
            </ol>
          </div>
        </nav>
        ...
        <section className="section-padding" style={{ backgroundColor: 'var(--brand-100)' }}>
          <div className="container-wide max-w-4xl">
            ...
            <h1 className="mb-4">
              Local Drain Cleaner vs. a National Chain — What Actually Matters
            </h1>
          ...
          <div className="container-wide">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <article className="lg:col-span-3">
                ...
                <div id="at-a-glance" className="scroll-mt-24 mb-12">
                  <h2 className="mt-0 mb-4">At a Glance</h2>
                  <div className="overflow-x-auto rounded-xl" style={{ border: '1px solid var(--line)' }}>
                    <table className="w-full text-sm">
                      <thead>
                        <tr style={{ backgroundColor: 'var(--brand-900)', color: 'white' }}>
                          <th className="text-left px-5 py-4 font-700" style={{ fontWeight: 700 }}>
                            Factor
                          </th>
                          <th className="text-left px-5 py-4 font-700" style={{ fontWeight: 700 }}>
                            Local Company
                      ...
                      <tbody>
                        {comparisonRows.map((row, i) => (
                          <tr
                            key={i}
                            style={{
                              backgroundColor: i % 2 === 0 ? 'var(--white)' : 'var(--brand-100)',
                              borderTop: '1px solid var(--line)',
                            }}
                          >
                            <td
                              className="px-5 py-4 font-700"
                              style={{ fontWeight: 700, color: 'var(--navy-900)', verticalAlign: 'top' }}
                            >
                              {row.factor}
                            </td>
                            <td
                              className="px-5 py-4"
                              style={{ color: 'var(--ink)', verticalAlign: 'top' }}
                            >
                              {row.local}
                            </td>
                            <td
                              className="px-5 py-4"
                              style={{ color: 'var(--muted)', verticalAlign: 'top' }}
                            >
                              {row.national}
                            </td>
                          </tr>
                ...
                {/* Why This Comparison Matters More for Drains */}
                <div id="why-this-comparison-matters" className="scroll-mt-24 mb-12">
                  <h2 className="mb-4">Why This Comparison Matters More for Drains Than for Some Other Services</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    A drain emergency is time-sensitive — every extra step between you and an actual technician (a
                    national booking system, a call centre triage step, a dispatch queue that is not local) adds real
                    minutes while water damage or a backup gets worse. For a service you can schedule weeks ahead,
                    that layer of process matters less. For a backed-up drain at 11pm, it matters a lot.
                  </p>
                </div>

                {/* What a National Chain Structure Actually Means */}
                <div id="national-chain-structure" className="scroll-mt-24 mb-12">
                  <h2 className="mb-4">What a National Chain Structure Actually Means</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    Many national chains operate through franchising — the local truck showing up may be
                    independently owned and operated under a national brand, which means service quality, pricing,
                    and responsiveness can genuinely vary between locations even under the same name. That is not a
                    criticism of any specific company — it is simply how a franchise model works structurally, and it
                    is worth knowing before you call.
                  </p>
                </div>

                {/* Mid-article CTA box (orange accent) — after comparison table section */}
                <div
                ...
                <div id="questions-to-ask" className="scroll-mt-24 mb-12">
                  <h2 className="mb-4">Questions Worth Asking Whoever You Call</h2>
                  <div
                  ...
                  >
                    <ul className="flex flex-col gap-4">
                      {[
                        'Is the technician coming from nearby, or from another part of the city or region?',
                        'Am I speaking with the company doing the work, or a call centre that will pass my information along?',
                        'Is the price I am quoted confirmed by the person actually doing the work, or set by a national pricing structure?',
                      ].map((q, i) => (
                        <li key={i} className="flex items-start gap-3">
                          ...
                          <span className="leading-relaxed" style={{ color: 'var(--ink)' }}>{q}</span>
                        </li>
                      ))}
                    </ul>
                    <p className="mt-5 text-sm leading-relaxed" style={{ color: 'var(--muted)' }}>
                      A straight answer to all three tells you more than any advertising claim.
                    </p>
                  </div>
                </div>

                {/* Every Area We Serve Directly */}
                <div id="areas-we-serve" className="scroll-mt-24 mb-12">
                  <h2 className="mb-4">Every Area We Serve Directly</h2>
                  <div
                    className="rounded-xl p-6"
                    style={{ backgroundColor: 'var(--brand-100)', border: '1px solid var(--brand-700)' }}
                  >
                ...
                <div id="contact" className="scroll-mt-24 mb-12">
                  ...
                  <p className="mb-6 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    ...
                    — answered 24 hours a day, every day of the year, by the company actually doing the work. Email:{' '}
                    <a
                      href={`mailto:${EMAIL}`}
                      className="hover:underline"
                      style={{ color: 'var(--brand-700)' }}
                  ...
                  >
                    ...
                    <ContactForm prefilledService="General Inquiry" />
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-3">
                    {[
                      ...
                      },
                      {
                        ...
                        label: 'Drain Cleaning Company Near Me — Response Time',
                      },
                      {
