...
const tocItems = [
{ id: 'check-before-reno', label: 'Check This Before Renovation Day' },
{ id: 'why-check-first', label: 'Why Older Bathrooms Are Especially Worth Checking First' },
{ id: 'whats-behind-wall', label: "What's Typically Behind an Older Bathroom Wall" },
{ id: 'moving-fixtures', label: 'Moving Fixtures? This Matters Even More' },
{ id: 'timeline-fit', label: 'How This Fits Into Your Renovation Timeline' },
{ id: 'service-areas', label: 'Every Area We Provide Pre-Renovation Plumbing Assessments In' },
...
const faqs = [
{
  q: 'Do I need a plumbing assessment before every bathroom renovation, even a minor one?',
  a: "For a cosmetic-only update, it's less critical — but if you're moving fixtures or the bathroom is original to an older home, it's a reasonable precaution."
},
{
  q: 'Can you work directly with my renovation contractor?',
  a: "Yes — we're glad to coordinate scheduling and findings directly with your contractor."
},
{
  q: 'What if you find a problem behind the wall — does that delay my renovation?',
  a: 'It can add a short step to address it properly, but finding it before demo is far less disruptive than finding it mid-project.'
},
{
  q: 'Do you handle the actual plumbing work during the renovation too, or just the assessment?',
  a: 'We can do both — the assessment first, then the plumbing work itself as part of your renovation.'
},
{
  q: 'How far in advance should I book this before my renovation start date?',
  a: 'As early as you can once you have a renovation date — it gives the most flexibility if anything needs addressing beforehand.'
}];
...
const pageSchema = {
  ...
  {
    '@type': 'BlogPosting',
    headline: "Renovating an Old Winnipeg Bathroom? What's Behind the Wall You Should Know First",
    description:
    ...
    image: {
      ...
      description: 'Plumber checking pipes behind the wall during a Winnipeg bathroom renovation'
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': 'https://prodraincleaning.ca/blog/renovating-old-winnipeg-bathroom-plumbing'
    }
  },
  {
    '@type': 'FAQPage',
  ...
  },
  {
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://prodraincleaning.ca/blog' },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Renovating an Old Bathroom',
      item: 'https://prodraincleaning.ca/blog/renovating-old-winnipeg-bathroom-plumbing'
    }]
...
export default function RenovatingOldBathroomPost() {
      ...
      <main id="main-content">
        ...
        <section className="section-padding" style={{ backgroundColor: 'var(--brand-100)' }}>
          <div className="container-wide max-w-4xl">
            ...
            <h1 className="mb-4">
              Renovating an Old Winnipeg Bathroom? What's Behind the Wall You Should Know First
            </h1>
            ...
            <div className="rounded-xl overflow-hidden mb-8">
              {/*
                ...
                Example: src="/assets/images/bathroom-renovation-plumbing-check-winnipeg.jpg"
                This is the only line you need to change.
              */}
              <SwappableHeroImage
                src="/assets/images/emergency-plumber-main-shutoff-valve.png"
                alt="Plumber checking pipes behind the wall during a Winnipeg bathroom renovation"
                lazy={false}
                width={1600}
                height={900}
            ...
            {/* Check This Before Renovation Day quick-reference box */}
            <div
              id="check-before-reno"
              ...
              <p
                ...
                Check This Before Renovation Day
              </p>
              <ul className="flex flex-col gap-3">
                {[
                'What material are the supply and drain lines behind this wall?',
                'Any signs of past leaks, water damage, or previous repairs in this area?',
                'Does the existing layout support any changes you\'re planning (moving a fixture, adding a shower)?',
                'Is the venting for this bathroom adequate for the existing fixtures, let alone new ones?',
                'Is there any indication of mold or moisture damage that needs addressing before new finishes go in?'].
                map((item, i) =>
          ...
          <div className="container-wide">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <article className="lg:col-span-3">
                ...
                {/* Section: Why Check First */}
                <div id="why-check-first" className="scroll-mt-24">
                  <h2 className="mt-0 mb-4">Why Older Bathrooms Are Especially Worth Checking First</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    Bathrooms in older Winnipeg homes have often gone through multiple rounds of use, minor repairs, and sometimes previous DIY work over the decades — all of which can leave things behind the wall that don't match what a floor plan or a quick look would suggest. A moisture issue that was never fully addressed, a pipe material that's aged past its practical life, or a previous repair that wasn't done to a proper standard are all things far better to know about before demo, not after.
                  </p>
                </div>

                {/* Section: What's Typically Behind the Wall */}
                <div id="whats-behind-wall" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">What's Typically Behind an Older Bathroom Wall</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    Supply lines and drain lines that may be original to the home or from an earlier renovation, potentially in older materials that are worth confirming before you plan new fixture placements around them. Moisture-related wear is also common in bathroom walls specifically, given the environment — even without an obvious active leak, years of humidity and minor splashing can leave damage that isn't visible until the wall is opened.
                  </p>
                </div>

                {/* Mid-article CTA box (orange accent) — after "What's Typically Behind an Older Bathroom Wall" */}
                <div
                ...
                {/* Section: Moving Fixtures */}
                <div id="moving-fixtures" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">Moving Fixtures? This Matters Even More</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    If your renovation plan includes moving a toilet, sink, or shower to a new location, that's not just a cosmetic decision — it means rerouting drain and supply lines, which needs to be planned around the home's actual existing plumbing layout, not just the new design on paper. Getting this assessed before your contractor starts avoids mid-project surprises and change orders.
                  </p>
                </div>

                {/* Section: Timeline Fit */}
                <div id="timeline-fit" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">How This Fits Into Your Renovation Timeline</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    A plumbing assessment before demo day is a short step that protects the rest of your renovation schedule — catching an issue now costs you a delay of days, catching it after the walls are already open and finishes are being planned can cost weeks.
                  </p>
                </div>

                {/* Section: Service Areas */}
                <div id="service-areas" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">Every Area We Provide Pre-Renovation Plumbing Assessments In</h2>
                ...
                <div className="mt-12 pt-8" style={{ borderTop: '1px solid var(--line)' }}>
                  ...
                  <ul className="flex flex-col gap-3">
                    {[
                    {
                      href: '/blog/new-construction-rough-in-plumbing-inspection-winnipeg',
                      label: 'New Construction Rough-In Plumbing Inspection — What Gets Missed'
                    },
                    {
