...
const tocItems = [
{ id: 'coverage-pattern', label: 'General Coverage Pattern' },
{ id: 'sudden-vs-gradual', label: 'Why "Sudden and Accidental" Matters' },
{ id: 'what-affects-coverage', label: 'What Can Affect Your Coverage' },
{ id: 'filing-claim', label: "What to Do If You're Filing a Frozen Pipe Claim" },
{ id: 'what-we-can-tell', label: 'What We Can and Can\'t Tell You' },
{ id: 'service-areas', label: 'Every Area We Serve for Frozen Pipe Claims Support' },
...
const faqs = [
{
  q: 'Is frozen pipe damage always covered?',
  a: "It's typically covered as a sudden, accidental event, but specifics like whether the home was adequately heated can affect coverage — confirm with your own insurer."
},
{
  q: 'What if my home was vacant when the pipe froze?',
  a: "Extended vacancy without precautions can be a factor in some policies — worth reviewing your specific policy's vacancy clause."
},
{
  q: 'Will you speak to my insurance company directly?',
  a: 'We can provide documentation your insurer or adjuster requests; specific coverage questions go to them directly.'
},
{
  q: 'Does calling a plumber quickly help my claim?',
  a: 'Generally yes — prompt action to address the damage and a professional service record both support a smoother claims process.'
},
{
  q: 'What\'s the difference between a "sudden" and "gradual" claim?',
  a: 'A sudden event (like a pipe bursting) is typically treated differently than gradual, long-term damage that went unaddressed — your insurer can clarify how this applies to your specific situation.'
}];
...
const pageSchema = {
  ...
  {
    '@type': 'BlogPosting',
    headline: 'Does Home Insurance Cover Frozen Pipe Damage in Manitoba?',
    description:
    ...
    image: {
      ...
      description: 'Plumber documenting frozen pipe damage for a Manitoba insurance claim'
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': 'https://prodraincleaning.ca/blog/does-home-insurance-cover-frozen-pipes-manitoba'
    }
  },
  {
    '@type': 'FAQPage',
  ...
  },
  {
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://prodraincleaning.ca/blog' },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Frozen Pipes & Insurance Coverage',
      item: 'https://prodraincleaning.ca/blog/does-home-insurance-cover-frozen-pipes-manitoba'
    }]
...
export default function DoesInsuranceCoverFrozenPipesPost() {
      ...
      <main id="main-content">
        ...
        <section className="section-padding" style={{ backgroundColor: 'var(--brand-100)' }}>
          <div className="container-wide max-w-4xl">
            ...
            <h1 className="mb-4">
              Does Home Insurance Cover Frozen Pipe Damage in Manitoba?
            </h1>
            ...
            <div className="rounded-xl overflow-hidden mb-8">
              {/*
                ...
                Example: src="/assets/images/frozen-pipe-insurance-documentation-winnipeg.jpg"
                This is the only line you need to change.
              */}
              <SwappableHeroImage
                src="/assets/images/technician-upfront-pricing-homeowner-winnipeg.png"
                alt="Plumber documenting frozen pipe damage for a Manitoba insurance claim"
                lazy={false}
                width={1600}
                height={900}
            ...
            {/* General Coverage Pattern quick-reference box */}
            <div
              id="coverage-pattern"
              ...
              <p className="text-xs mb-4" style={{ color: 'var(--muted)' }}>
                Confirm specifics with your own insurer or broker
              </p>
              <ul className="flex flex-col gap-3">
                {[
                'Sudden, accidental frozen pipe bursts are typically covered under standard home insurance',
                'Coverage can be affected if the home was left inadequately heated (many policies expect a minimum temperature to be maintained)',
                'Extended vacancy without proper precautions can affect a claim',
                'Gradual, long-term damage (as opposed to a sudden burst) may be treated differently than a sudden event',
                'Documentation of the cause and repair work generally supports a smoother claims process'].
                map((item, i) =>
          ...
          <div className="container-wide">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <article className="lg:col-span-3">
                ...
                {/* Section: Sudden vs Gradual */}
                <div id="sudden-vs-gradual" className="scroll-mt-24">
                  <h2 className="mt-0 mb-4">Why "Sudden and Accidental" Matters</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    Insurance policies generally distinguish between a sudden, accidental event (a pipe that froze and burst without warning) and a gradual problem that developed over time and went unaddressed. A frozen pipe bursting is usually treated as the former, but the specific circumstances — how the home was maintained, whether it was heated, whether there was any prior indication of a problem — are what your insurer actually evaluates.
                  </p>
                </div>

                {/* Section: What Can Affect Your Coverage */}
                <div id="what-affects-coverage" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">What Can Affect Your Coverage</h2>
                  <ul className="flex flex-col gap-4 mb-6">
                    {[
                    {
                      title: 'Whether the home was adequately heated.',
                      text: 'Many policies specify a minimum interior temperature (often cited around 16°C/60°F) that needs to be maintained, especially if the home was unoccupied.'
                    },
                    {
                      title: 'How long the home was vacant, if it was.',
                      text: 'Extended vacancy without arrangements for someone to check on the property can be a factor in some policies.'
                    },
                    {
                      title: 'Whether reasonable preventive steps were taken.',
                      text: 'Not shutting off water and draining pipes before an extended absence in winter, for example, can be relevant.'
                    },
                    {
                      title: 'Documentation of what happened and when.',
                      text: 'A clear timeline and professional assessment supports your claim regardless of the specific circumstances.'
                    }].
                    map((item, i) =>
                    <li key={i} className="flex items-start gap-3 text-sm" style={{ color: 'var(--ink)' }}>
                        <span
                ...
                {/* Mid-article CTA box (orange accent) — after "What Can Affect Your Coverage" */}
                <div
                ...
                <div id="filing-claim" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">What to Do If You're Filing a Frozen Pipe Claim</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    Get the immediate damage addressed first (see our{' '}
                    <Link
                    ...
                    ), then gather documentation — photos, a professional service record identifying the cause, and a timeline of events. See our full{' '}
                    <Link
                    ...
                    for what an adjuster typically wants to see.
                  </p>
                </div>

                {/* Section: What We Can and Can't Tell You */}
                <div id="what-we-can-tell" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">What We Can and Can't Tell You</h2>
                  <p className="mb-4 leading-relaxed" style={{ color: 'var(--ink)' }}>
                    We can identify the cause of a frozen pipe or burst, document the repair work, and give you a clear written record for your insurer. We're not insurance advisors and don't speak to your specific policy's terms, exclusions, or deductible — that conversation belongs with your insurer or broker.
                  </p>
                </div>

                {/* Section: Service Areas */}
                <div id="service-areas" className="scroll-mt-24 mt-12">
                  <h2 className="mb-4">Every Area We Serve for Frozen Pipe Claims Support</h2>
