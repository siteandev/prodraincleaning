  ...
  return (
    ...
    >
      <div className="container-wide text-center max-w-3xl mx-auto">
        ...
        >
          Still Watching the Water Rise? Stop Waiting.
        </h2>
        <p className="text-lg mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.8)' }}>
          We answer the phone at 2 a.m. on a Sunday in February. Tell us what&apos;s happening and we&apos;ll tell you what it will cost — before we touch anything.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          ...
          <Link
            ...
            className="btn-secondary-white w-full sm:w-auto text-base"
